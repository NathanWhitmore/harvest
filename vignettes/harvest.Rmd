...
Giving an annual growth rate of ~14.6% per year.
...
The ```harvest_tolerance()``` function sends a dataframe called "Monte.Carlo" to the R global environment which allows the user to undertake further graphing. 
